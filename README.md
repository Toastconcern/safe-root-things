...
| [Power Indicator LED](https://github.com/FreeXR/safe-root-things/blob/main/things/powerindicatorled.sh) | LED changes color depending on charge | confirmed eureka/panther | UID0/SELinux Permissive? | push, chmod +X, exec
